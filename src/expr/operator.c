...
token_t * calc_add(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, sum_str, strlen(sum_str), DIGIT, OP_ADD, 0);
    return dst;
}
...
token_t * calc_minus(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, minus_str, strlen(minus_str), DIGIT, OP_MINUS, 0);
    return dst;
}
...
token_t * calc_mult(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, mult_str, strlen(mult_str), DIGIT, OP_MULT, 0);
    return dst;
}
...
token_t * calc_div(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, div_str, strlen(div_str), DIGIT, OP_DIV, 0);
    return dst;
}
...
token_t * calc_remaind(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, remaind_str, strlen(remaind_str), DIGIT, OP_REMMAIND, 0);
    return dst;
}
...
token_t * calc_power(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, res_str, strlen(res_str), DIGIT, OP_POWER, 0);
    return dst;
}
...
token_t * calc_sin(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, sin_str, strlen(sin_str), DIGIT, OP_SIN, 0);
    return dst;
}
...
token_t * calc_cos(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, cos_str, strlen(cos_str), DIGIT, OP_COS, 0);
    return dst;
}
...
token_t * calc_tan(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, tan_str, strlen(tan_str), DIGIT, OP_TAN, 0);
    return dst;
}
...
token_t * calc_ctan(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, ctan_str, strlen(ctan_str), DIGIT, OP_CTAN, 0);
    return dst;
}
...
token_t * calc_log(token_t * dst, token_t * op1, token_t * op2) {
    ...
    set_token(dst, log_str, strlen(log_str), DIGIT, OP_LOG, 0);
    return dst;
}