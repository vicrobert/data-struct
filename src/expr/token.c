...
void set_token(token_t * dst, const char * lex, const int lex_len, const token_type_t token_type,
               const op_code_t code, const int prior, const double value) {
